...
def run_cv_TwoBranchEEGNet(n_folds=5, ep=10):
    ...
    for i in range(n_folds):
        ...
        network = net.TwoBranchEEGNet(ep=ep)
        ...
        fname = f'outputs/TwoBranchEEGNet_{fold}_hpc'
        plot_accuracy_and_loss(history, 'Two-branch EEGNet', True, fname)
